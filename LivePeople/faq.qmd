...
- [pandas](https://pandas.pydata.org/pandas-docs/stable/index.html), a python library. Parquet file can be [read](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.read_parquet.html) with `pd.read_parquet('path/to/dataset.parquet')`;
- [DuckDB](https://duckdb.org/), a in-process database solution (see how to read parquet file on [DuckDB documentation](https://duckdb.org/docs/stable/data/parquet/overview));
