...
|------------------|-----------------|-----------------|-----------------|-------------|
| Bluetooth        | Accelerometer   | Location        | Airplane Mode   | Light       |
| Cellular Network | Gyroscope       | Magnetic field  | Battery Charge  | Pressure    |
| WiFi             | Activities      | Proximity       | Battery Level   |             |
| WiFi Networks    | Step Counter    |                 | Doze Mode       |             |
|                  | Step Detector   |                 | Ring Mode       |   |
|                  |                 |                 | Touch event     |    |
|                  |                 |                 | Screen status   |  |
|                  |                 |                 | User Presence   |             |
